...
export class ExperimentController extends EventTarget{
  ...
  async tick(){
    ...
    try{
      ...
      if(this.training)learningInfo=this.policy.learn({observation:obs,temporal:decision.temporal,features:decision.features,stateSignature:decision.stateSignature,actionIndex:decision.actionIndex,reward:step.reward,nextObservation:step.observation,nextTemporal:nextEncoded.temporal,nextFeatures:nextEncoded.features,done:step.done});
      ...
      this.trace.push({
        ...
        uncertainty:decision.uncertainty,valueBeta:decision.valueBeta??0,priorKL:decision.priorKL??0,valueTrust:decision.valueTrust??0,basePriorKlBudget:decision.basePriorKlBudget??0,priorKlBudget:decision.priorKlBudget??0,klUtilization:decision.klUtilization??0,valueEpistemic:decision.valueEpistemic??0,valueEpistemicBudget:decision.valueEpistemicBudget??0,epistemicUtilization:decision.epistemicUtilization??0,typedValueFit:decision.typedValueFit??0,typedValueBlendUsed:decision.typedValueBlendUsed??0,criticGap:decision.criticGap??0,criticGapShare:decision.criticGapShare??0,criticTopAgreement:decision.criticTopAgreement??0,criticMarginSnr:decision.criticMarginSnr??0,criticRankingConfidence:decision.criticRankingConfidence??0,criticAuthority:decision.criticAuthority??0,criticKlGate:decision.criticKlGate??1,criticKlMultiplier:decision.criticKlMultiplier??1,replayEvidenceConfidence:decision.replayEvidenceConfidence??0,replayEvidenceSupportGate:decision.replayEvidenceSupportGate??0,replayEvidenceAdvantageGate:decision.replayEvidenceAdvantageGate??0,replayEvidenceReturnDelta:decision.replayEvidenceReturnDelta??0,replayCriticSupport:decision.replayCriticSupport??0,replayPriorSupport:decision.replayPriorSupport??0,replayCriticMeanReturn:decision.replayCriticMeanReturn??0,replayPriorMeanReturn:decision.replayPriorMeanReturn??0,valueBetaSaturated:!!decision.valueBetaSaturated,semanticPrior:decision.semanticPriorScores?.[decision.actionIndex]??null,learnedValue:decision.valueScores?.[decision.actionIndex]??null,combinedScore:decision.qScores?.[decision.actionIndex]??null,latencyMs:decision.latencyMs,semanticLatencyMs:decision.semanticLatencyMs,residualLatencyMs:decision.residualLatencyMs,
