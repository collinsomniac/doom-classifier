...
function renderArchitecture(obs,d,outcome){
  ...
  setArchNode("fusion",{active:!!d,hot:!!d&&Number(d.valueBeta||0)>0,value:d?("β "+Number(d.valueBeta||0).toFixed(2)+" · AUTH "+(Number(d.criticAuthority||0)*100).toFixed(0)+"% · KL cap "+Number(d.priorKlBudget||0).toFixed(3)+" · used "+(Number(d.klUtilization||0)*100).toFixed(0)+"% · → "+d.action.id):"β 0 · AUTH 0% · KL 0%"});
