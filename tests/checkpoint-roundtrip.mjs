...
const semantic=new HashSemanticAdapter();const source=new SemanticResidualPolicy({schema,actions,semantic,residual:"neural-set",seed:44,inferenceMode:"neural"});
...
const target=new SemanticResidualPolicy({schema:{...schema,objective:"placeholder"},actions:[...actions].reverse(),semantic:new HashSemanticAdapter(),residual:"neural-set",seed:999,inferenceMode:"adaptive"});
